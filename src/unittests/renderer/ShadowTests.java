...
public class ShadowTests {
	 ...
	 * 
	 * @param pictName     the name of picture
	 * @param triangle     the triangle to add to scene
	 * @param spotLocation the spotlight location in the scene
	 */
	...
	public void sphereTriangleMove1() {
		sphereTriangleHelper("shadowSphereTriangleMove2", //
				new Triangle(new Point(-70, -40, 27), new Point(-40, -70, 27), new Point(-68, -68, 23)), //
				new Point(-100, -100, 200));
	}
